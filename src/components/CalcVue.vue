...
<template>
  <div class="titulo"><h1>CALCULADORA MUITO MASSA</h1></div>
  <main>
    <div class="calc">
      ...
      <div class="valores-forms">
        <label for="select-servico">Qual foi a qualidade do serviço?</label>
        <select
      ...
      <div class="valores-forms">
        <label for="input-pessoas">Quantas pessoas vão pagar a conta?</label>
        <input
          v-model="pessoa"
          placeholder="1"
          id="input-pessoas"
    ...
    <div class="resultado">
      ...
      <span>R$ {{ final_v }} por pessoa</span>
    </div>
  </main>
</template>
